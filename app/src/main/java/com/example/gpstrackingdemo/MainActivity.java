...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv_lat, tv_lon, tv_altitude, tv_accuracy, tv_speed, tv_sensor, tv_updates, tv_address,tv_countOfCrambs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_countOfCrambs=findViewById(R.id.tv_countOfCrambs);
        ...
        btn_showWayPointList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(MainActivity.this,ShowSavedLocationListActivity.class);
...
fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
    ...
    private void updateUIValues(Location location) {
        ...
        MyApplication myApplication=(MyApplication)getApplicationContext();
        savedLocations=myApplication.getMyLocations();
        tv_countOfCrambs.setText(String.valueOf(savedLocations.size()));
    }
}
